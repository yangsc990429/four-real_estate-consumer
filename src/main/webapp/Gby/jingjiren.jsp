...
<div align="center">
    <table class="table table-bordered" id="jingjiren" align="center"></table>
</div>
...
<script type="text/javascript">
    $(function(){
        $("#jingjiren").bootstrapTable({
            url:"<%=request.getContextPath()%>/gby/queryjingji",
    ...
    function hyrenzhengbt(flag,id){
        if(flag == 1){
            location.href="<%=request.getContextPath()%>/Gby/updatezhuang.jsp?flag=2&id="+id;
        }else if(flag == 2){
            location.href="<%=request.getContextPath()%>/Gby/updatezhuang.jsp?flag=1&id="+id;
        }else{
            location.href="<%=request.getContextPath()%>/Gby/updatezhuang.jsp?flag=1&id="+id;
        }
    }
