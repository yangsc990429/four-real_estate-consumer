        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="upForm">
                    ...
                    原始名称：<input  type='text'  name='yuanname'/><br/>
                    展示名称：<input  type='text'  name='zhanname'/><br/>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;排序：<input type='text' id="paixu" name='xuhao' /><font size="1">序号越小，越靠前</font><br/>
...
<script type="text/javascript">
    ...
    function updatewuyeleixing(id){
        $.ajax({
            url:"<%=request.getContextPath()%>/dw/updatewuyeleixing",
            type:"post",
            data:{"id":id},
            dataType:"json",
            success:function (dw){
                $("#id1").val(dw.id);
                $("#yuanname").val(dw.yuanname);
                $("#zhanname").val(dw.zhanname);
                $("#xuhao").val(dw.xuhao);
                $("#xiaozu").val(dw.xiaozu);
                $("#statusup").val(dw.statusup);
                $("#photoimg").val(dw.photoimg);
                $('#myModal1').modal({
                    keyboard:false,
                })
            }
