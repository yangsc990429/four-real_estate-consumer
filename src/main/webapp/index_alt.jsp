...
<head>
  ...
  <link rel="shortcut icon" href="#" type="<%=request.getContextPath()%>/css/image/png">

  <title>AdminX</title>

  <!--icheck-->
  <link href="<%=request.getContextPath()%>/css/js/iCheck/skins/minimal/minimal.css" rel="stylesheet">
  <link href="<%=request.getContextPath()%>/css/js/iCheck/skins/square/square.css" rel="stylesheet">
  <link href="<%=request.getContextPath()%>/css/js/iCheck/skins/square/red.css" rel="stylesheet">
  <link href="<%=request.getContextPath()%>/css/js/iCheck/skins/square/blue.css" rel="stylesheet">

  <!--dashboard calendar-->
  <link href="<%=request.getContextPath()%>/css/css/clndr.css" rel="stylesheet">

  <!--Morris Chart CSS -->
  <link rel="stylesheet" href="<%=request.getContextPath()%>/css/js/morris-chart/morris.css">
  ...
  <!--[if lt IE 9]>
  <script src="<%=request.getContextPath()%>/css/js/html5shiv.js"></script>
  <script src="<%=request.getContextPath()%>/css/js/respond.min.js"></script>
  <![endif]-->
</head>
...
<section>
    ...
    <div  class="left-side sticky-left-side">
        ...
        <div class="logo">
            <a href="index.html"><img src="<%=request.getContextPath()%>/css/images/logo.png" alt=""></a>
        </div>

        <div class="logo-icon text-center">
            <a href="index.html"><img src="<%=request.getContextPath()%>/css/images/logo_icon.png" alt=""></a>
        </div>
        ...
        <div class="left-side-inner">
            ...
            <div class="visible-xs hidden-sm hidden-md hidden-lg">
                <div class="media logged-user">
                    <img alt="" src="<%=request.getContextPath()%>/css/images/photos/user-avatar.png" class="media-object">
                ...
                <ul class="notification-menu">
                    ...
                    <li>
                        ...
                        <div class="dropdown-menu dropdown-menu-head pull-right">
                            ...
                            <ul class="dropdown-list normal-list">
                                <li class="new">
                                    <a href="">
                                        <span class="thumb"><img src="<%=request.getContextPath()%>/css/images/photos/user1.png" alt="" /></span>
                                        <span class="desc">
                                ...
                                <li>
                                    <a href="">
                                        <span class="thumb"><img src="<%=request.getContextPath()%>/css/images/photos/user2.png" alt="" /></span>
                                        <span class="desc">
                                ...
                                <li>
                                    <a href="">
                                        <span class="thumb"><img src="<%=request.getContextPath()%>/css/images/photos/user3.png" alt="" /></span>
                                        <span class="desc">
                                ...
                                <li>
                                    <a href="">
                                        <span class="thumb"><img src="<%=request.getContextPath()%>/css/images/photos/user4.png" alt="" /></span>
                                        <span class="desc">
                                ...
                                <li>
                                    <a href="">
                                        <span class="thumb"><img src="<%=request.getContextPath()%>/css/images/photos/user5.png" alt="" /></span>
                                        <span class="desc">
                    ...
                    <li>
                        <a href="#" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                            <img src="<%=request.getContextPath()%>/css/images/photos/user-avatar.png" alt="" />
                            John Doe
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <ul class="goal-progress">
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <img src="<%=request.getContextPath()%>/css/images/photos/user2.png" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <img src="<%=request.getContextPath()%>/css/images/photos/user3.png" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <img src="<%=request.getContextPath()%>/css/images/photos/user4.png" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <img src="<%=request.getContextPath()%>/css/images/photos/user5.png" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                            <a href="#">Hoffman Doe</a> - Support
...
<script src="<%=request.getContextPath()%>/css/js/jquery-ui-1.9.2.custom.min.js"></script>
<script src="<%=request.getContextPath()%>/css/js/jquery-migrate-1.2.1.min.js"></script>
<script src="<%=request.getContextPath()%>/css/js/bootstrap.min.js"></script>
<script src="<%=request.getContextPath()%>/css/js/modernizr.min.js"></script>
<script src="<%=request.getContextPath()%>/css/js/jquery.nicescroll.js"></script>

<!--easy pie chart-->
<script src="<%=request.getContextPath()%>/css/js/easypiechart/jquery.easypiechart.js"></script>
<script src="<%=request.getContextPath()%>/css/js/easypiechart/easypiechart-init.js"></script>

<!--Sparkline Chart-->
<script src="<%=request.getContextPath()%>/css/js/sparkline/jquery.sparkline.js"></script>
<script src="<%=request.getContextPath()%>/css/js/sparkline/sparkline-init.js"></script>

<!--icheck -->
<script src="<%=request.getContextPath()%>/css/js/iCheck/jquery.icheck.js"></script>
<script src="<%=request.getContextPath()%>/css/js/icheck-init.js"></script>

<!-- jQuery Flot Chart-->
<script src="<%=request.getContextPath()%>/css/js/flot-chart/jquery.flot.js"></script>
<script src="<%=request.getContextPath()%>/css/js/flot-chart/jquery.flot.tooltip.js"></script>
<script src="<%=request.getContextPath()%>/css/js/flot-chart/jquery.flot.resize.js"></script>


<!--Morris Chart-->
<script src="<%=request.getContextPath()%>/css/js/morris-chart/morris.js"></script>
<script src="<%=request.getContextPath()%>/css/js/morris-chart/raphael-min.js"></script>

<!--Calendar-->
<script src="<%=request.getContextPath()%>/css/js/calendar/clndr.js"></script>
<script src="<%=request.getContextPath()%>/css/js/calendar/evnt.calendar.init.js"></script>
<script src="<%=request.getContextPath()%>/css/js/calendar/moment-2.2.1.js"></script>
...
<!--Dashboard Charts-->
<script src="<%=request.getContextPath()%>/css/js/dashboard-chart-init.js"></script>
