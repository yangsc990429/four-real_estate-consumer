                      ...
                      <%--  <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <label><input name="check" id="a" type="checkbox" value="1"/>装修案例管理</label>
                                <label><input name="check" id="b" type="checkbox" value="2"/>独立商铺</label>
                            </td>
                            <td></td>
                        </tr>
    ...
    $(function(){
            $.ajax({
                ...
                success:function (date){
                 ...
                 //   Huirenzhuang{huirenid=2, huirenztai='1', huishenid=4, huirenjjyy='null', huirenzsxm='张三', huirensfzh='41226553228563254', huirensfzzm='', huirensfzfm='null', huijizhanghao='1451654645321'}
...
//那么现在来检测s的值就知道选中的复选框的值了
         $.ajax({
              url:"<%=request.getContextPath()%>/yangsc/updateSeji",
              type:"post",
