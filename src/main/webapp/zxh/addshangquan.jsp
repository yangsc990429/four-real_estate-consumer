        ...
        <table>
            ...
            <tr>
                ...
                <td width="220px" colspan="4">
                    <div><script id="content" name="textarea" type="text/plain" style="width:100%;height:95%;"></script></div>
                </td>
            </tr>
        </table>
        <br/>
        ...
        <table>
            ...
            <tr>
                <td width="150px" colspan="5" align="center">
                    <button type="button" class="btn btn-success" onclick="insertBus()">保存添加</button>
...
<script type="text/javascript">
    ...
    function insertBus(){
        $.ajax({
            url:"<%=request.getContextPath()%>/zxh/insertBusin",
            type:"post",
            data:$("#addshangquan").serialize(),
            dataType:"text",
            success:function (data){
                if(data == "success"){
                    $("#myModalxcbzx").modal({
